...
import com.example.voyagar.ui.CameraDisplayView;
import com.example.voyagar.ui.OverlayDisplayView;
import com.example.voyagar.utilities.PlacesUtilities;
import com.example.voyagar.utilities.SensorUtilities;
...
import static com.example.voyagar.helper.Constants.LOCATION_UPDATE_DISPLACEMENT;
import static com.example.voyagar.helper.Constants.LOCATION_UPDATE_INTERVAL;
import static com.example.voyagar.helper.Constants.REFINE_SEARCH_INTENT;
...
public class OverlayActivity extends AppCompatActivity implements
    ...
    private void getNearbyPlaces(final Location currentLocation) {
        if(mCurrentTypesString.isEmpty()){
            Toast.makeText(
                    getApplicationContext(),
                    getString(R.string.category_search),
        ...
        // Get nearby places from Places API
